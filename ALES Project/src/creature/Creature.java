...
public class Creature {
    ...
    /**
     * Generates a child creature given two creatures by combining chromosomes. Mutations are handled at the chromosomal level.
     * 
     * @param other The creature's partner, the genetic material of which will be used to produce the child creature
     * @return  A child creature generated by combining the chromosomes from each creature, the chromosomes of which are combined with the chromosomal reproduce method
     */
